...
public class HelpScene extends BaseScene {
    ...
    public void build() {
        ...
        solarsystem.setStyle("-fx-font-weight: bold;");
        ...
        planet.setStyle("-fx-font-weight: bold;");
        ...
        notif.setStyle("-fx-font-weight: bold;");
        ...
        dashboard1_view.setFitWidth(200);
        ...
        dashboard2_view.setFitWidth(200);
        ...
        tasks.setStyle("-fx-font-weight: bold;");
